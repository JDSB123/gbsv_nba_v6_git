...
class OddsSnapshot(Base):
    ...
    captured_at = Column(DateTime, nullable=False, default=lambda: datetime.now(UTC), index=True)
...
class Prediction(Base):
    ...
    predicted_at = Column(DateTime, nullable=False, default=lambda: datetime.now(UTC), index=True)
...
class Injury(Base):
    ...
    reported_at = Column(DateTime, nullable=False, default=lambda: datetime.now(UTC))
