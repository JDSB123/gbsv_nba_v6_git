...
def upgrade() -> None:
    ...
    _recreate_fk("player_game_stats", "player_game_stats_player_id_fkey", "player_id", "players", "id")
...
def downgrade() -> None:
    ...
    op.alter_column("games", "status", existing_type=sa.String(10), nullable=True, server_default=None)
    op.alter_column("games", "season", existing_type=sa.String(10), nullable=True, server_default=None)
    op.alter_column("players", "is_active", existing_type=sa.Boolean(), nullable=True, server_default=None)
    ...
    _recreate_fk_no_action("team_season_stats", "team_season_stats_team_id_fkey", "team_id", "teams", "id")
    _recreate_fk_no_action("player_game_stats", "player_game_stats_player_id_fkey", "player_id", "players", "id")
    _recreate_fk_no_action("player_game_stats", "player_game_stats_game_id_fkey", "game_id", "games", "id")
    _recreate_fk_no_action("odds_snapshots", "odds_snapshots_game_id_fkey", "game_id", "games", "id")
